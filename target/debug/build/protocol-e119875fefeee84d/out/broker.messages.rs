...
pub struct PortfolioMessage {
    #[prost(oneof = "portfolio_message::Payload", tags = "1")]
    pub payload: ::core::option::Option<portfolio_message::Payload>,
}
/// Nested message and enum types in `PortfolioMessage`.
...
pub struct PublishRequest {
    #[prost(string, repeated, tag = "1")]
    pub topics: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    #[prost(oneof = "publish_request::Payload", tags = "2, 3")]
...
pub mod publish_request {
    ...
    pub enum Payload {
        ...
        #[prost(message, tag = "3")]
        PorfolioPayload(super::PortfolioMessage),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
