...
impl Orderbook {
    ...
    fn calculate_depths(
        ...
        // Best level depths
        metrics.best_bid_depth = if let Ok(best_bid) = NotNan::new(metrics.best_bid) {
        ...
        metrics.best_ask_depth = if let Ok(best_ask) = NotNan::new(metrics.best_ask) {
...
mod tests {
    ...
    fn test_orderbook_creation() {
        ...
        // Basic assertions
        assert_eq!(orderbook._instrument, "BTC/USD");
        assert_eq!(orderbook._exchange, "Kraken");
