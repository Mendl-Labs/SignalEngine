...
impl PerformanceMetrics {
    ...
    pub fn record_latency(&mut self, component: &str, operation: &str, latency_ns: u64) {
        ...
        let entry = self.latencies.entry(key).or_default();
